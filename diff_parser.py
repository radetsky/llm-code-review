...
class DiffParser:
    ...
    def get_diff(self, mode: str = "staged", base: Optional[str] = None, head: Optional[str] = None) -> str:
        ...
        for file_data in parsed_files:
            ...
            for hunk in hunks:
                if hunk["added_lines"] or hunk["removed_lines"]:
                    formatted_sections.append(f"Lines {hunk['new_start']}-{hunk['new_start'] + hunk['new_count'] - 1}:")
